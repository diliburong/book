	...
	<form action="" method="post" class="form form-horizontal" id="form-category-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-5 col-sm-7">
				...
				<img id="preview_id2" src="/admin/static/h-ui.admin/images/icon-add.png" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id2').click()" />
				...
				<img id="preview_id3" src="/admin/static/h-ui.admin/images/icon-add.png" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id3').click()" />
				...
				<img id="preview_id4" src="/admin/static/h-ui.admin/images/icon-add.png" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id4').click()" />
				...
				<img id="preview_id5" src="/admin/static/h-ui.admin/images/icon-add.png" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id5').click()" />
