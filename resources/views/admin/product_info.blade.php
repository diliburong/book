...
<form class="form form-horizontal" action="" method="post">
  ...
  <div class="row cl">
    <label class="form-label form-label col-xs-4 col-sm-3"><span class="c-red"></span>类别：</label>
    <div class="formControls col-5">
      {{$product->category->name}}
    </div>
  </div>
  <div class="row cl">
    <label class="form-label form-label col-xs-4 col-sm-3">预览图：</label>
    <div class="formControls col-5">
  ...
  <div class="row cl">
    <label class="form-label form-label col-xs-4 col-sm-3">详细内容：</label>
    <div class="formControls col-8">
      {{$pdt_content->content}}
    </div>
  </div>
  <div class="row cl">
    <label class="form-label form-label col-xs-4 col-sm-3">产品图片：</label>
    <div class="formControls col-8">
